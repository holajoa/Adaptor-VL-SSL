...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--projection_dim", type=int, default=768, help="dimension of projection head"
    )
    ...
    logging.basicConfig(
        filename=f"logs/train_{log_fn}.log", encoding="utf-8", level=logging.INFO
    )

    num_of_gpus = torch.cuda.device_count()
    logging.info(
        f"Number of available GPUs = {num_of_gpus}: "
