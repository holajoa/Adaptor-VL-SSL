...
python3 ./pretrain_from_scratch.py --vision_model_type ae --vision_pretrained 101-elastic --text_pretrained "dmis-lab/biobert-v1.1" --batch_size 256 --data_pct 1.0 --num_hidden_layers 1 --num_train_epochs 10 --seed 42 --output_dir ./results/BioBERT_ResNetAE --num_workers 8 --lr 1e-4
/usr/bin/nvidia-smi
uptime