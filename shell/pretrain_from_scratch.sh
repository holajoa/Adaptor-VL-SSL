...
python3 ./pretrain_from_scratch.py --vision_model_type ae --vision_pretrained 101-elastic --text_pretrained "dmis-lab/biobert-v1.1" --batch_size 128 --data_pct 0.01 --num_hidden_layers 1 --num_train_epochs 10 --seed 42 --output_dir ./results/BioBERT_ResNetAE
/usr/bin/nvidia-smi
uptime