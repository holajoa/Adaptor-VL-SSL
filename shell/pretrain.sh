...
python ./pretrain.py --vision_model_type ae --vision_pretrained 101-elastic --text_pretrained "./weights/ClinicalBERT_checkpoint/ClinicalBERT_pretraining_pytorch_checkpoint" --batch_size 128 --data_pct 1.0 --num_hidden_layers 1 --num_of_batches -1 --num_train_epochs 10 --seed 42 --text_embeds_raw_dir $SAVED_EMBEDDINGS_DIR/text_embeds/ClinicalBERT --image_embeds_raw_dir $SAVED_EMBEDDINGS_DIR/image_embeds/ResNetAE --output_dir ./results/ClinicalBERT_ResNetAE --num_workers 1 --lr 5e-5
/usr/bin/nvidia-smi
uptime