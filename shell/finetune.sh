...
export SAVED_MODEL_DIR="/vol/bitbucket/jq619/individual-project/results"
export VISION_MODEL="resnet-ae" 
export TEXT_MODEL="biobert"
# export TEXT_MODEL="bert"
# export TEXT_MODEL="clinicalbert"
python ./finetune.py --vision_model $VISION_MODEL --text_model $TEXT_MODEL --batch_size 128 --data_pct 1.0 --num_workers 1 --num_hidden_layers 1 --num_train_epochs 30 --seed 42 --lr 1e-4 --output_dir $SAVED_MODEL_DIR/${VISION_MODEL}_${TEXT_MODEL}
/usr/bin/nvidia-smi
uptime