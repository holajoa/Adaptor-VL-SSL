...
do
    ...
    do
        python ./pretrain.py --vision_model $VISION_MODEL --text_model $TEXT_MODEL --num_layers 2 --batch_size 1024 --data_pct 1.0 --num_workers 1 --num_train_epochs 100 --seed 42 --lr 2.5e-4 --output_dir $SAVED_MODEL_DIR/${VISION_MODEL}_${TEXT_MODEL}_v2 --wandb 
