...
DATA_BASE_DIR = os.path.join(os.path.dirname(os.path.abspath(__file__)), "../../../autodl-tmp/data")
...
# MIMIC_CXR_DATA_DIR = DATA_BASE_DIR / "raw/physionet.org/files/mimic-cxr/2.0.0"
...
# SIIM constants
# #############################################
# PNEUMOTHORAX_DATA_DIR = DATA_BASE_DIR / "siim-acr-pneumothorax-segmentation"
PNEUMOTHORAX_DATA_DIR = DATA_BASE_DIR / "pneumothorax"
...
# COVIDx constants
# #############################################
COVIDX_DATA_DIR = DATA_BASE_DIR / "covidx-cxr2"
...
# #############################################
OBJ_DATA_DIR = DATA_BASE_DIR / "foreign-objects-in-chest-xrays/object-CXR"
