...
from mgca.datasets.detection_dataset import OBJCXRDetectionDataset, RSNADetectionDataset
...
def cli_main():
    ...
    parser.add_argument(
        "--dataset", type=str, default="rsna", help="rsna or object_cxr"
    )
    ...
    ckpt_dir = os.path.join(BASE_DIR, f"../../../data/ckpts/detection/{extension}")
    ...
    callbacks = [
        ...
        EarlyStopping(
            monitor="val_mAP", min_delta=0.0, patience=10, verbose=False, mode="max"
        ),
    ]
